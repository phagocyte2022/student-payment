...
public class StudentOrderChild {
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "childCertificateNumber", column = @Column(name = "c_certificate_number")),
            @AttributeOverride(name = "childCertificateDate", column = @Column(name = "c_certificate_date"))
    ...
    public void setStudentOrderChildId(Long studentOrderChildId) {
        StudentOrderChildId = studentOrderChildId;
    }
